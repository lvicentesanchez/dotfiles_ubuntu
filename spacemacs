...
(defun dotspacemacs/layers ()
  ...
  (setq-default
   ...
   ;; packages then https://github.com/syl20bnr/spacemacs/tree/master/layers/%2Btools/shellconsider to create a layer, you can also put the
